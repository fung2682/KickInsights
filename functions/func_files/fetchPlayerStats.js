...
const fetchPlayerPassing = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of passing_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerPassTypes = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of pass_types_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerGoalShotCreation = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of gsc_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerDefensiveActions = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of defensive_actions_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerPossession = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of possession_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerMisc = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of misc_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerGoalkeeping = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of goalkeeping_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
...
const fetchPlayerGoalkeepingAdvanced = (table) => {
    ...
    for (let row of table_rows) {   // for each player
        ...
        for (let col of goalkeeping_adv_stats_raw) {      // for each stat
            let cell_value = col.match(/>.*</)[0].slice(1, -1)
            cell_value === '' ? cell_value = '-' : null;
