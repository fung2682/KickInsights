...
import { updateData, getClubs } from "../firebase/firestore.js";
...
// club id in FBREF
const club_id_by_name = ['18bb7c10', '8602292d', '4ba7cbea', 'cd051869', 'd07537b9', '943e8050', 'cff3d9bb', '47c64c55', 'd3fd31cc', 'fd962109',
                        '822bd0ba', 'e297cd13', 'b8fd03ef', '19538871', 'b2b47a98', 'e4a775cb', '1df6b87e', '361ca564', '7c21e445', '8cec06e1']

const fetchClubStats = async (start_index, end_index) => {

    const start = new Date();
    const dataClubs = await getClubs();
    console.log("checkpoint:" + dataClubs.length)
    const mid = new Date();
    console.log("Time taken for fetchClubStats (get dataClubs): ", (mid - start) / 1000, "s");
    ...
    for (let i = start_index; i < end_index; i++) {
        ...
        console.log(`Finished fetching ${dataClubs[i].club.name_code}, time taken: `, (func_end - func_start) / 1000, "s");
    }
    const end = new Date();
    console.log("Time taken for fetchClubStats: ", (end - start) / 1000, "s");
}
