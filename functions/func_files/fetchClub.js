...
const kit_id_by_name = [1, 2, 127, 130, 131, 43, 4, 6, 7, 34, 10, 163, 11, 12, 23, 15, 18, 21, 25, 38]

const fetchClubs = async (start_index, end_index) => {
    for (let i = start_index; i < end_index; i++) {
        ...
        const end = new Date();
        console.log(`Time taken for fetchClubs (club ${i}): ${(end - start)/1000} s`);
    }
}
