...
const UseModelLayout = ({setPage, header, button1, button2, button3, button4, content, modelChecked, setModelChecked, setLogisticRegressionValues, setAdaBoostValues, setRfValues, setLrValues, setKnnValues, setABValues, setSvmValues, seasonChecked, setSeasonChecked, statisticsList, setStatisticsList}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.formContainer}>
          <View style={[styles.formHeader, {backgroundColor: "#287334"}]}>
