    ...
    return (
        <View style={styles.game}>
            ...
            <View style={styles.row}>
                ...
                <Image source={{uri: clubLogo[`${last? `${lastMatch.homeShortName}` : `${nextMatch.homeShortName}`}`]}} 
                style={styles.image}/>
                {
                    last?
                ...
                <Image source={{uri: clubLogo[`${last? `${lastMatch.awayShortName}` : `${nextMatch.awayShortName}`}`]}} 
                style={styles.image}/>
